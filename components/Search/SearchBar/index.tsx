...
const SearchBar = ({ onClose }: SearchBarProps) => {
    ...
    useLayoutEffect(() => {
        ...
        console.log(btn.offsetLeft, btn.offsetWidth, btn.offsetHeight);
        ...
        <form className={styles.form} onSubmit={onSubmit}>
            ...
            <div className={styles.platforms}>
                ...
                <div ref={platformsRef} className={styles.platforms}>
                    <button className={styles.platform_btn} style={{opacity: platform === 0 ? 0.8 : 0.5}} onClick={ (e) => { onPlatformBtnClick(e, 0) } }>
                    ...
                    <button className={styles.platform_btn} style={{opacity: platform === 1 ? 0.8 : 0.5}} onClick={ (e) => { onPlatformBtnClick(e, 1) }}>
                    ...
                    <button className={styles.platform_btn} style={{opacity: platform === 2 ? 0.8 : 0.5}} onClick={ (e) => { onPlatformBtnClick(e, 2) }}>
