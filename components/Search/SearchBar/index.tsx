        ...
        <form className={styles.form} onSubmit={onSubmit}>
            ...
            <div className={styles.platforms}>
                ...
                <div ref={platformsRef} className={styles.platforms}>
                    ...
                    <button className={styles.platform_btn} style={{opacity: platform === 1 ? 0.9 : 0.75, color: platform === 1 ? "#1c1c1c" : ""}} onClick={ (e) => { onPlatformBtnClick(e, 1) }}>
                    ...
                    <button className={styles.platform_btn} style={{opacity: platform === 2 ? 0.9 : 0.75, color: platform === 2 ? "#1c1c1c" : ""}} onClick={ (e) => { onPlatformBtnClick(e, 2) }}>
